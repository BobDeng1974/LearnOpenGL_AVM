...
int main()
{
    ...
    for(int angle = -45; angle <=45; angle++)
    {
        ...
        if(angle > 0) {
            ...
            AppendVertexArray(vertexArray, 134.0f, 400.0f, minR, maxR, (float)angle);
            ...
            minR = radiu3-5.0f;
            maxR = radiu3+5.0f;
            AppendVertexArray(vertexArray, -134.0f, 0.0f, minR, maxR, (float)angle);
        }
