                            ...
                            float _angle)
{
    ...
    //std::cout << " vertexArray.size() = " << vertexArray.size()  << std::endl;
    ...
    if(_angle == 0.0f){
        ...
        //std::cout << " _angle = " << _angle << " _frontLeftMinX.size() = " << _frontLeftMinX.size() << " _frontLeftMinZ.size() = " << _frontLeftMinZ.size() << std::endl;
        //std::cout << " _angle = " << _angle << " _frontRightMaxX.size() = " << _frontRightMaxX.size() << " _frontRightMaxZ.size() = " << _frontRightMaxZ.size() << std::endl;
...
int main()
{
    ...
    for(int angle = 45; angle >= 1; angle--)
    {
        ...
        if(angle > 0) {
            ...
            // std::cout << "==============================================1=====frontLeftMinX.size = " << frontLeftMinX.size() << std::endl;

            // for (float n : frontLeftMinX) {
            //     std::cout << "frontLeftMinX(nei rong) = " << n << '\n';
            // }

            // std::cout << "===============================================2====frontLeftMinZ.size = " << frontLeftMinZ.size() << std::endl;

            // for (float n : frontLeftMinZ) {
            //     std::cout << "frontLeftMinZ(nei rong) = " << n << '\n';
            // }

            // generateLineVertexArray(lineVertexArray, frontLeftMinX, frontLeftMinZ, (float)angle);
            // generateLineVertexArray(lineVertexArray, frontLeftMaxX, frontLeftMaxZ, (float)angle);

            //std::cout << "===============================================3====lineVertexArray.size = " << lineVertexArray.size() << std::endl;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // shaderProgramArea.setFloat("u_alpha", 0.1f);
