...
void AppendVertexArray(std::vector<float>& arrayVertex, float beginX, float endX,
                        float rMin, float rMax, float _angle,
                        std::list<float>& insideLineX, std::list<float>& insideLineZ,
                        enum Radius which)
{
    float x0 = -134.0f;
    ...
    while(_beginX <= endX){
        ...
        if(abs(z + z0) <  abs(z0)) {
            ...
            if(which == MAX) {insideLineX.push_back(_beginX); insideLineZ.push_back(z + z0);}
    ...
    while(_beginX <= endX){
        ...
        if(abs(z + z0) <  abs(z0)) {
            ...
            if(which == MIN) {insideLineX.push_back(_beginX); insideLineZ.push_back(z + z0);}
    ...
    for(int i = 0; i < rectangleNum; i++){
        ...
        //arrayVertex.push_back(1.0f - alpha*i);
        arrayVertex.push_back(alpha);
...
int areaRiangleNum = 0;

void generateAreaVertexArray(std::vector<float>& areaVertexArray,
                            std::list<float>& array1X, std::list<float>& array1Z,
                            std::list<float>& array2X, std::list<float>& array2Z,
                            float _angle)
{
    int rectangleNum = min(array1X.size(), array2X.size()) - 1;
    int triangleNum = abs(array1Z.size() - array2Z.size());

    float alpha = 0.2f;

    for(int i = 0; i < rectangleNum; i++){
        float minXone = array1X.front();
        float minZone = array1Z.front();

        float maxXone = array2X.front();
        float maxZone = array2Z.front();
        ...
        float minXtwo = array1X.front();
        float minZtwo = array1Z.front();

        float maxXtwo = array2X.front();
        float maxZtwo = array2Z.front();

        areaVertexArray.push_back(minXone);
        areaVertexArray.push_back(0.1f);
        areaVertexArray.push_back(minZone);
        areaVertexArray.push_back(_angle);
        areaVertexArray.push_back(alpha);

        areaVertexArray.push_back(maxXone);
        areaVertexArray.push_back(0.1f);
        areaVertexArray.push_back(maxZone);
        areaVertexArray.push_back(_angle);
        areaVertexArray.push_back(alpha);

        areaVertexArray.push_back(minXtwo);
        areaVertexArray.push_back(0.1f);
        areaVertexArray.push_back(minZtwo);
        areaVertexArray.push_back(_angle);
        areaVertexArray.push_back(alpha);
        ...
        areaVertexArray.push_back(maxXtwo);
        areaVertexArray.push_back(0.1f);
        areaVertexArray.push_back(maxZtwo);
        areaVertexArray.push_back(_angle);
        areaVertexArray.push_back(alpha);
    ...
    // for(int i = 0; i < triangleNum; i++){
    //     if(array1Z.size() == 1){
    //         float minX = array1X.front();
    //         float minZ = array1Z.front();
    ...
    //         areaVertexArray.push_back(minX);
    //         areaVertexArray.push_back(0.1f);
    //         areaVertexArray.push_back(minZ);
    //         areaVertexArray.push_back(_angle);
    //         areaVertexArray.push_back(alpha);
    ...
    //     }else if(array2Z.size() == 1){
    //         float maxX = array2X.front();
    //         float maxZ = array2Z.front();
    ...
    //         areaVertexArray.push_back(maxX);
    //         areaVertexArray.push_back(0.1f);
    //         areaVertexArray.push_back(maxZ);
    //         areaVertexArray.push_back(_angle);
    //         areaVertexArray.push_back(alpha);
...
int main()
{
    ...
    for(int angle = -45; angle <=45; angle++)
    {
        ...
        if(angle > 0) {
            ...
            AppendVertexArray(vertexArray, 134.0f, 400.0f, minR, maxR, (float)angle, frontLeftMinX, frontLeftMinZ, MIN);
            ...
            AppendVertexArray(vertexArray, 134.0f, 400.0f, minR, maxR, (float)angle, frontRightMaxX, frontRightMaxZ, MAX);
            ...
            AppendVertexArray(vertexArray, -134.0f, 100.0f, minR, maxR, (float)angle, backRightMaxX, backRightMaxZ, NO);

            generateAreaVertexArray(areaVertexArray, frontLeftMinX, frontLeftMinZ, frontRightMaxX, frontRightMaxZ, (float)angle);
        }
        ...
        if(angle < 0) {
            ...
            AppendVertexArray(vertexArray, 134.0f, 400.0f, minR, maxR, (float)angle, frontLeftMaxX, frontLeftMaxZ, MAX);
            ...
            AppendVertexArray(vertexArray, 134.0f, 400.0f, minR, maxR, (float)angle, frontRightMinX, frontRightMinZ, MIN);
            ...
            AppendVertexArray(vertexArray, -134.0f, 100.0f, minR, maxR, (float)angle, backLeftMaxX, backLeftMaxZ, NO);
