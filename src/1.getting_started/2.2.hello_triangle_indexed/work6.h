...
const char *vertexShaderSource = "#version 330 core\n"
    ...
    "       ourColor = aColor;\n"
     "   }else{\n"
     "       ourColor = vec4(0.234f, 0.234f, 0.406f, 0.3f);\n"
     "   }\n"
    "}\0";
                                 ...
                                 int degreeNumber)  //degree about the radar(each degree is one little rectangle)
{
    ...
    // printf("topLeftX = %f, topLeftY = %f\n", topLeftX, topLeftY);
    // printf("bottomLeftX = %f, bottomLeftY = %f\n", bottomLeftX, bottomLeftY);
    // printf("topRightX = %f, topRightY = %f\n", topRightX, topRightY);
    // printf("bottomRightX = %f, bottomRightY = %f\n", bottomRightX, bottomRightY);
    ...
    for(int i = 0; i < radarNumber; i++)
    {
        ...
        float _bottomLeftY = topLeftY > 0.0 ? (topLeftY - (i+1)*(fabs(topLeftY-bottomLeftY)/radarNumber)) : (topLeftY + (i+1)*(fabs(topLeftY-bottomLeftY)/radarNumber));
        ...
        float _bottomRightY = topRightY > 0.0 ? (topRightY - (i+1)*(fabs(topRightY-bottomRightY)/radarNumber)) : (topRightY + (i+1)*(fabs(topRightY-bottomRightY)/radarNumber));


        printf("_topLeftX = %f, _topLeftY = %f\n", _topLeftX, _topLeftY);
        printf("_bottomLeftX = %f, _bottomLeftY = %f\n", _bottomLeftX, _bottomLeftY);
        printf("_topRightX = %f, _topRightY = %f\n", _topRightX, _topRightY);
        printf("_bottomRightX = %f, _bottomRightY = %f\n", _bottomRightX, _bottomRightY);
        printf("\n");
        printf("\n");
...
//--------------------------------------generate vertex array--------------------------------------------------------
    ...
    radarNum = 1;
    degreeNumber = 5;
    AppendVertexArrayWithSector(vertexArray, indexArray, -45.0f, -22.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    ...
    radarNum = 1;
    degreeNumber = 5;
    AppendVertexArrayWithSector(vertexArray, indexArray, 22.5f, 45.0f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    radarNum = 2;
    degreeNumber = 15;
    AppendVertexArrayWithSector(vertexArray, indexArray, 157.5f, 202.5f, 0.4f, 1.0f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    radarNum = 4;
    degreeNumber = 3;
    AppendVertexArrayWithRectangle(vertexArray, indexArray, 45.0f, 135.0f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    radarNum = 4;
    degreeNumber = 3;
    AppendVertexArrayWithRectangle(vertexArray, indexArray, 225.0f, 315.0f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
