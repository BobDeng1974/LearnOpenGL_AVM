...
std::map<RADAR_ENUM, std::map<int, int> > radarMap;
...
//--------------------------------------generate vertex array-----2---------------------------------------------------
    ...
    radarNum = 1;
    degreeNumber = 20;
    AppendVertexArrayWithSector(vertexArray, indexArray, -21.5f, -1.5f, 0.4f, 0.8f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    rectanglePeerRadarWithoutDegree = 5;
    radarNum = 1;
    degreeNumber = 20;
    AppendVertexArrayWithSector(vertexArray, indexArray, 1.5f, 21.5f, 0.4f, 0.8f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    radarNum = 1;
    degreeNumber = 20;
    AppendVertexArrayWithSector(vertexArray, indexArray, 158.5f, 178.5f, 0.4f, 0.8f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    rectanglePeerRadarWithoutDegree = 5;
    radarNum = 1;
    degreeNumber = 20;
    AppendVertexArrayWithSector(vertexArray, indexArray, 181.5f, 201.5f, 0.4f, 0.8f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 47.5f, 66.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 69.5f, 88.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 91.5f, 110.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 113.5f, 132.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
    ...
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 227.5f, 246.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 249.5f, 268.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 271.5f, 290.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;

    // rectanglePeerRadarWithoutDegree = 1;
    // radarNum = 1;
    // degreeNumber = 15;
    // AppendVertexArrayWithRectangle(vertexArray, indexArray, 293.5f, 312.5f, 0.4f, 0.6f, rectanglePeerRadarWithoutDegree, radarNum, degreeNumber);
    // totalNumber += rectanglePeerRadarWithoutDegree*radarNum*degreeNumber;
