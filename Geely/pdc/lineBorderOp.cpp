...
void lineBorderOp::CalLine2D(int index,float* outpt,unsigned short* outIndex,int posx,int posy, int width, int height)
{
    ...
    CalEndPt2D(pt3,pt4,0,&outpt[ptElementNum],0,&outIndex[indexElementNum]);
...
void lineBorderOp::CalEndPt2D(const point2D& pt,const point2D& prevPt,float width,float* out,unsigned short startIndex,unsigned short* outIndex)
{
