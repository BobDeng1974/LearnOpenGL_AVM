...
void lineBorderOp::CalLine2DBackground(float* input,int ptNum,float width,unsigned short startIndex,float* outpt,unsigned short* outIndex/*unsigned int* outIndex*/)
{
	point2D pt1(0.0,0.0);//p0
	point2D pt2(640.0,0.0);//p1
	point2D pt3(0.0,480.0),pt4(640.0,480.0);
	CalStartPt2DBorderPts(pt1,pt2,width,outpt);
	outpt[2] = 0.0;
	outpt[3] = 0.0;
	outpt[6] = 1.0;
