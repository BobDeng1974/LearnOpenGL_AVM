...
public:
	...
	void CalLine2DBackground(float* input,int ptNum,float width,unsigned short startIndex,float* outpt,/*unsigned int* outIndex*/unsigned short* outIndex);
...
private:
	...
	void CalMidPt2DBorderPts(const point2D& pt1,const point2D& pt2,const point2D& pt3,const point2D& pt4,float width,
		unsigned short startIndex,float* out,unsigned short* outIndex/*unsigned int* outIndex*/);
