...
typedef struct _linesData{
	...
	int* pLinePtNums; //num of veterx on a segment of side line or a  mark distance line,distance line starts at index2 
	float** pLineData;  //coordinate of the veterx on a segment of side line(save in first and second pLineData) or distance line(save in last 5 pLineData),distance line starts at index2 
