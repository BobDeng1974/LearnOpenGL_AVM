...
//take these value as near and far distance in perspective view volume
#define RVS_GUIDELINE_GROUP_NUM         3     //set L segment dist length to zero. the guidle line out from bumper has 2 style:0.5m and 1m & red and orange----but allocate??
#define RVS_GUIDELINE_L_SEGMENT_DISTANCE   1              //should <1.0 as L segment out the bumper within 1m
#define RVS_GUIDELINE_NON_L_SEGMENT_DISTANCE   2              //should <1.0 as L segment out the bumper within 1m

//#define RVS_GUIDELINE_FAR_END_DISTANCE   14.1                //the far end of the guideline in the realworld, 5 as 5m which  should equal the far distance of the camera view
...
#define RVS_GUIDELINE_WIDTH             (10) //the width in pixels of the line dispalyed, not the length =4/320

#define RVS_COLOR_RED                   {1.0,0.0,0.0}
#define RVS_COLOR_YELLOW                {1.0,1.0,0.0}
#define RVS_COLOR_GREEN                {0.0,1.0,0.0}
#define RVS_COLOR_BLUE					{0.0,0.0,1.0}
#define RVS_COLOR_PINK                {1.0,0.0,1.0}
#define RVS_COLOR_LIGNTBLUE                {0.1,0.69,0.78}


//parameter define the distance line
#define RVS_OVLAY_MARKER_WIDTH 3    //define the width of the distance line ---2.72=2.72m in the real world should equal the width of the car

#define RVS_OVLAY_THICK_DIST_MARKS 0.08   // the distance of two lines which between 2 side line, as in realworld repesents 1 m
#define RVS_OVLAY_NUM_DIST_MARKS 1  // the num of line nums you will see on the overlaywindow which mark the distance in the real world, you can use two lines to check the perspective view but it is not smooth in application, need 2D process to expand the line width
#define RVS_OVLAY_NUM_SIDE_LINE   2  //2 //2 side lines
#define RVS_OVLAY_SUM_LINE_PER_GROUP   (RVS_OVLAY_NUM_DIST_MARKS + RVS_OVLAY_NUM_SIDE_LINE) //2 
//#define RVS_OVLAY_LINE_WIDTH 4

#define RVS_GUIDELINE_FAR_END_DISTANCE   1.5
#define RVS_OVLAY_TRACK_WIDTH 0.84
#define RVS_OVLAY_SIDE_WIDTH 0.72
#define RVS_GUIDELINE_MARKER_STARTDIS    0.6    //the begin distance of the guideline,should equals to the end of L segment
#define RVS_OVLAY_DELTA_DIST_MARKS 0.3   // the distance of two lines which between 2 side line, as in realworld repesents 1 m
